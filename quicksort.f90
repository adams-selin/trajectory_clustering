...
!
! Stolen directly from http://www.cesm.ucar.edu/models/atm-cam/docs/cam3.0/cam30fv-browser/html_code/utils/quicksort.F90.html
! Rest of documentation/code is directly from that website
!
