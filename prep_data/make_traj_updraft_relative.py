...
for rstnum in rstnums:
    ...
    with open(directory+'/cm1out_haildata_traj.pkl','rb') as f:
    ...
    #convert to m from km
    all_rightx = all_rightx * 1.E3
    all_righty = all_righty * 1.E3
    ...
    leftds.to_netcdf(directory+'/cm1out_haildata_traj_leftWrelative.nc',
        encoding=encoding)
    rightds.to_netcdf(directory+'/cm1out_haildata_traj_rightWrelative.nc',
        encoding=encoding)
