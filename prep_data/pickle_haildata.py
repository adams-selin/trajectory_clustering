...
#directories = ['20120529_zshape_fixvt','20120529_zheat','20120529_zmassagg','20120529_zvt']
directories = ['20120529','20120529_zvt']
#directories = ['20120529_zheat','20120529_zmassagg']  #Need to run zshape_fixvt,zheat for rst34+

for directory in directories:
    print ('')
    print (directory)

    low_thresholds = [15, 19, 25, 45, 50.]
    hi_thresholds = [19, 25, 45, 50, 150.]

    rstnums = np.arange(36,37)
    ...
    for rstnum in rstnums:
        ...
        filename = '/glade/derecho/scratch/radams/'+directory+'/rst0000'+rstnumd+'/cm1out_haildata.nc'
        ...
        for low_threshold, hi_threshold in zip(low_thresholds,hi_thresholds):
            ...
            full_path = '/'.join(filename.split('/')[:-1])
            with open(full_path+'/haildata_ge'+str(int(low_threshold))+
